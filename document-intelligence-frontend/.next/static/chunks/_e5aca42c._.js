...
function UploadForm({ onUpload }) {
    ...
    const { getRootProps, getInputProps, isDragActive } = useDropzone({
        ...
        onDrop: {
            "UploadForm.useDropzone": (acceptedFiles)=>onUpload(acceptedFiles)
        }["UploadForm.useDropzone"]
    });
...
_s(UploadForm, "YfI2qKQYNDOj7ozxGshQtast5Mk=", false, function() {
    return [
        useDropzone
    ];
});
...
//# sourceMappingURL=_e5aca42c._.js.map